...
Any images, scripts, or fonts required globally by the Dash UI should be dropped into this directory so that Dash automatically registers and serves them.
